...
class TteamsTeamCardAlphaWidget extends StatefulWidget {
  const TteamsTeamCardAlphaWidget({super.key});

  @override
  State<TteamsTeamCardAlphaWidget> createState() =>
      _TteamsTeamCardAlphaWidgetState();
}

class _TteamsTeamCardAlphaWidgetState extends State<TteamsTeamCardAlphaWidget> {
  late TteamsTeamCardAlphaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TteamsTeamCardAlphaModel());
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                0.0, 4.0, 12.0, 0.0),
                            child: Text(
                              'Equipo alpha  dominios Tareas, y Proyectos',
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
