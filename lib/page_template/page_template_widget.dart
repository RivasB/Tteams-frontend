...
class PageTemplateWidget extends StatefulWidget {
  const PageTemplateWidget({super.key});
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                              ...
                                              Padding(
                                                padding: const EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        16.0, 4.0, 0.0, 0.0),
                                                child: Text(
                                                  'Comportamiento de las tareas y su completamiento',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelMedium
                                                      .override(
                                                          ...
                                                          padding:
                                                              const EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      0.0),
                                                          child: Text(
                                                            'Algunas tareas asignadas a tu equipo',
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .labelMedium
                                                                .override(
                                ...
                                wrapWithModel(
                                  model: _model.tteamsActivityModel,
                                  updateCallback: () => safeSetState(() {}),
                                  child: const TteamsActivityWidget(),
                                ),
                              ].divide(const SizedBox(width: 16.0)),
                            ),
                          ),
