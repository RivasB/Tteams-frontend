...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    tTeamsAuthUserSubject.add(
      TTeamsAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<TTeamsAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  TTeamsAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = TTeamsAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    tTeamsAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
