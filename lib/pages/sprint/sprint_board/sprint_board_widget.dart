...
import 'sprint_board_model.dart';
export 'sprint_board_model.dart';

class SprintBoardWidget extends StatefulWidget {
  const SprintBoardWidget({super.key});
...
class _SprintBoardWidgetState extends State<SprintBoardWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SprintBoardModel());
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          wrapWithModel(
                            model: _model.sprintOptionsModel,
                            updateCallback: () => safeSetState(() {}),
                            child: const SprintOptionsWidget(),
                          ),
                          Row(
                            mainAxisSize: MainAxisSize.max,
                            crossAxisAlignment: CrossAxisAlignment.start,
                                                                ...
                                                                child: Column(
                                                                  ...
                                                                  children: [
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        'Implementar endpoint que devuelva los detalles de una tarea',
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .headlineMedium
                                                                            .override(
                                                                              fontFamily: FlutterFlowTheme.of(context).headlineMediumFamily,
                                                                ...
                                                                child: Column(
                                                                  ...
                                                                  children: [
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        'Reuniones de equipo, calificar requisitos, identificar riesgos y coordinar trabajo.',
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .headlineMedium
                                                                            .override(
                                                                              fontFamily: FlutterFlowTheme.of(context).headlineMediumFamily,
                                                              ...
                                                              padding:
                                                                  const EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          16.0),
                                                              child: Text(
                                                                'Implementar endpoint para cambiar de estado una tarea',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .headlineMedium
                                                                    .override(
                                                              ...
                                                              padding:
                                                                  const EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          16.0),
                                                              child: Text(
                                                                'Implementar endpoint que devuelva una lista de tareas',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .headlineMedium
                                                                    .override(
                                                            ...
                                                            padding:
                                                                const EdgeInsetsDirectional
                                                                    .fromSTEB(
                                                                        ...
                                                                        16.0),
                                                            child: Text(
                                                              'Diseñar una pantalla para visualizar las tareas',
