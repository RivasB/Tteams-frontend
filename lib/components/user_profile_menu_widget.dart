...
class _UserProfileMenuWidgetState extends State<UserProfileMenuWidget>
  ...
  void initState() {
    ...
    _model.nameTextController ??=
        TextEditingController(text: FFAppState().UserMe.data.firstName);
    _model.nameFocusNode ??= FocusNode();

    _model.lastNameTextController ??=
        TextEditingController(text: FFAppState().UserMe.data.lastName);
    _model.lastNameFocusNode ??= FocusNode();

    _model.telefonoTextController ??=
        TextEditingController(text: FFAppState().UserMe.data.phone);
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'Detalles y opciones generales de tu perfil',
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.network(
                                  'https://images.unsplash.com/photo-1640960543409-dbe56ccc30e2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxMHx8Z2VuZXJpYyUyMHVzZXJ8ZW58MHx8fHwxNzI3NzI0NjM1fDA&ixlib=rb-4.0.3&q=80&w=1080',
                                  width: 64.0,
                                  height: 64.0,
                                  fit: BoxFit.cover,
                                ),
